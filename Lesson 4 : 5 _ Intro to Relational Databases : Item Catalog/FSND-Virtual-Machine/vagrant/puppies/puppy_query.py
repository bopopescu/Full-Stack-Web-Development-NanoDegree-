...
def query_one():
    """Query all of the puppies and return the results in ascendin
    alphabetical order"""
...
def query_three():
    ...
    result = session.query(Puppy.name,
                           Puppy.weight).order_by(Puppy.weight.asc()).all()
...
def passesLeapDay(today):
    """
    Returns true if most recent February 29th occured after or exactly 183
    days ago (366 / 2)
    """
